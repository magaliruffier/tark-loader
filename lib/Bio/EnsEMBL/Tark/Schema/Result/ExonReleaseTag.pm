...
package Bio::EnsEMBL::Tark::Schema::Result::ExonReleaseTag;
...
=head1 TABLE: C<exon_release_tag>

=cut

__PACKAGE__->table("exon_release_tag");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:As67utStZIfz4Xel36GqpA
