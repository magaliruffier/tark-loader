use utf8;
package Bio::EnsEMBL::Tark::Schema::Result::Tag;
...
__PACKAGE__->set_primary_key("transcript_id", "tagset_id");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:qLLfTVrZmGLtL6QmCZY6KA
