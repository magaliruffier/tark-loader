use utf8;
package Bio::EnsEMBL::Tark::Schema::Result::TranslationReleaseTag;
...
=head1 TABLE: C<translation_release_tag>

=cut

__PACKAGE__->table("translation_release_tag");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:1e6PJvxcCdHlQ7y6jAjKVg
