...
CREATE INDEX `loc_chk` ON `transcript` (`transcript_checksum` ASC);
...
CREATE INDEX `loc_chk` ON `exon` (`exon_checksum` ASC);
...
CREATE INDEX `name_version_idx` ON `tagset` (`tag_shortname` ASC, `version` ASC);

CREATE INDEX `fk_Tagset_1_idx` ON `tagset` (`session_id` ASC);

CREATE INDEX `short_name_idx` ON `tagset` (`tag_shortname` ASC);
...
CREATE INDEX `short_name_idx` ON `release` (`short_name` ASC);

CREATE INDEX `fk_release_1_idx` ON `release` (`assembly_id` ASC);

CREATE INDEX `fk_release_2_idx` ON `release` (`session_id` ASC);
