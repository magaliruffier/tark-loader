...
CREATE TABLE `transcript` (
  ...
  /* change schema to add biotype */
  `biotype` varchar(40) DEFAULT NULL,
  `three_prime_utr_start` int(10) unsigned DEFAULT NULL,
  `three_prime_utr_end` int(10) unsigned DEFAULT NULL,
  `three_prime_utr_seq` longtext DEFAULT NULL,
  `three_prime_utr_checksum` binary(20) DEFAULT NULL,
  `five_prime_utr_start` int(10) unsigned DEFAULT NULL,
  `five_prime_utr_end` int(10) unsigned DEFAULT NULL,
  `five_prime_utr_seq` longtext DEFAULT NULL,
  `five_prime_utr_checksum` binary(20) DEFAULT NULL,
